...
function vaarargout = FilteringGUI(varargin)
...
% Last Modified by GUIDE v2.5 02-Apr-2019 12:07:41
...
% Im_flat_bg = handles.UpdatedFlat;
...
% Istd = std2(Icn); 
% 
% ImDataLine = imgaussfilt(Icn,handles.GaussSlider.Value); 
% handles.UpdatedFlat = ImDataLine;
...
function ImDataLine = LineCorrection(hObject,Im_data,Background)

Im_flat_bg = Im_data - Background;
...
% make sure to reset the slider values 
...
varargout{6} = getimage(handles.UpdatedImage); % how to get this to be the image in the axes?
